  ...
  return (
    <div>
      <div
        ...
        onClick={onClose}
      >
        <div className="relative p-2 w-full max-w-md max-h-full" onClick={(e) => e.stopPropagation()}>
          <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-900 opacity-100">
